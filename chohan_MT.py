...
print('''Cho-Han, by Al Sweigart al@inventwithpython.com and modified by mt:

In this traditional Japanese dice game, two dice are rolled in a bamboo
cup by the dealer sitting on the floor. The player must guess if the
dice total to an even (cho) or odd (han) number. 
If the user gets a 2 or 7 on a dice roll, they get a 10 mon bonus.
''')
...
while True:  # Main game loop.
    ...
    if dice_total == 2 or dice_total == 7:
        print(f'Bonus! You rolled a {dice_total} and received a 10 mon bonus.')
